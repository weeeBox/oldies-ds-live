...
namespace DuckstazyLive.app.game
{
    public class HeroMedia
    {
        ...
        public void drawDuck(int playerIndex, Graphics g, float x, float y, float power, bool flip, float wingsAngle, float trans)
        {
        ...
        public void drawSleep(Graphics g, float x, float y, bool flip, float trans)
        {
            //DrawMatrix mat = DrawMatrix.ScaledInstance;
        ...
        public void drawDead(Graphics g, float x, float y, bool flip, float trans)
        {
            //DrawMatrix mat = DrawMatrix.ScaledInstance;
            //ColorTransform color = new ColorTransform(1.0f, 1.0f, 1.0f, trans);
        ...
        public void updateSFX(float x)
        {
            ...
            transformPanVol.volume = 0.3f + RandomHelper.rnd() * 0.7f;
        }
        ...
        public void playStep()
        {
            ...
            //var trans:SoundTransform = new SoundTransform(RandomHelper.rnd_float(0.3, 1.0f), utils.pos2pan(pos.x+duck_w));
        }
        ...
        public void playWing()
        {
            ...
            //var trans:SoundTransform = new SoundTransform(RandomHelper.rnd_float(0.5, 1.0f)*(0.3 + power*0.7), utils.pos2pan(pos.x+duck_w));
        }
