        ...
        public override void Update(float dt)
        {
            ...
            if (isPlaying())
            {
                ...
                if (regen <= 0.0f)
                {
                    ...
                    if (pill != null)
                    {
                        pill.startMissle(10 + RandomHelper.rnd() * 620, -10.0f, 0);
                        pill.t2 = 0.1f;
                        pill.vx = (RandomHelper.rnd() * 300 - 150) * (pow + 0.1f);
                        pill.vy = RandomHelper.rnd() * pow * 200 + 100 * (1.0f + pow);
                        pill.user = rainLogic;
                ...
                if (partyCount < 20)
                {
                    ...
                    if (party <= 0.0f)
                    {
                        ...
                        if (pill != null)
                        {
                            pill.startPower(10 + RandomHelper.rnd() * 620, 390.0f - RandomHelper.rnd() * 160 * pow, (int)(RandomHelper.rnd() * 3.0f), false);
