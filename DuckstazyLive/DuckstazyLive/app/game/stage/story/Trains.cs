...
namespace DuckstazyLive.game.levels
{
    public class Trains : PillCollectLevelStage
    {
        ...
        private void drawElement(Graphics g, int tex, float x, float y, ref ColorTransform colorTransform)
        {
        ...
        public void toxicLogic(Pill pill, String msg, float dt)
        {
            ...
            else if (msg == "attack")
            {
                ...
                while (i > 0)
                {
                    ...
                    {
                        p.user = partyLogic;
                        p.startPower(pill.x, pill.y, (int)(RandomHelper.rnd() * 3), false);
                        pills.actives++;
                    }
                    --i;
                }
        ...
        public void partyLogic(Pill pill, String msg, float dt)
        {
            ...
            {
                pill.vx = (150.0f + 150.0f * pow) * (RandomHelper.rnd() * 2.0f - 1.0f);
                pill.vy = 75.0f + RandomHelper.rnd() * 50.0f;
                pill.t2 = 0.05f;
            }
        }
