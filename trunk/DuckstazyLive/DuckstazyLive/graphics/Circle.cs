...
namespace DuckstazyLive.graphics
{
    ...
    {
        public Circle(Vector2 center, float radius, int trianglesCount)
        {
            CreateGeometry(center, radius, trianglesCount);
        }

        private void CreateGeometry(Vector2 center, float radius, int trianglesCount)
        {
            ...
            double angle = 0;
            Vector3 position = new Vector3(center, 0);
